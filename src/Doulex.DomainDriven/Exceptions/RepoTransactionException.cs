...
/// </summary>
public class RepoTransactionException : DomainDrivenException
{
    /// <summary>
    /// Initializes a new instance of the DbTransactionException class
    /// </summary>
    public RepoTransactionException() : base("Database transaction operation failed")
    {
    ...
    public RepoTransactionException(string message) : base(message)
    {
        ErrorCode = "DB_TRANSACTION_FAILED";
        Severity = ExceptionSeverity.Error;
    ...
    public RepoTransactionException(string message, Exception innerException) : base(message, innerException)
    {
        ErrorCode = "DB_TRANSACTION_FAILED";
        Severity = ExceptionSeverity.Error;
